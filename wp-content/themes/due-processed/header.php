...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$due_processed_description = get_bloginfo( 'description', 'display' );
			if ( $due_processed_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $due_processed_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
